Return-Path: <linux-ext4+bounces-14715-lists+linux-ext4=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-ext4@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id uOtDO5DSrmm1JAIAu9opvQ
	(envelope-from <linux-ext4+bounces-14715-lists+linux-ext4=lfdr.de@vger.kernel.org>)
	for <lists+linux-ext4@lfdr.de>; Mon, 09 Mar 2026 15:00:48 +0100
X-Original-To: lists+linux-ext4@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [172.105.105.114])
	by mail.lfdr.de (Postfix) with ESMTPS id B277323A34D
	for <lists+linux-ext4@lfdr.de>; Mon, 09 Mar 2026 15:00:48 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id 8C364302AF02
	for <lists+linux-ext4@lfdr.de>; Mon,  9 Mar 2026 14:00:25 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id F36AE3CCA05;
...
X-Spamd-Result: default: False [-2.16 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-14715-lists,linux-ext4=lfdr.de];
	...
	MIME_TRACE(0.00)[0:+];
	FROM_NEQ_ENVFROM(0.00)[vbabka@kernel.org,linux-ext4@vger.kernel.org];
	FROM_NO_DN(0.00)[];
