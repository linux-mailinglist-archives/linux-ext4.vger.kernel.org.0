Return-Path: <linux-ext4+bounces-4941-lists+linux-ext4=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ext4@lfdr.de
Delivered-To: lists+linux-ext4@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id EC1899BB9D6
	for <lists+linux-ext4@lfdr.de>; Mon,  4 Nov 2024 17:08:32 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 7CD971F22668
	for <lists+linux-ext4@lfdr.de>; Mon,  4 Nov 2024 16:08:32 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3C4CE1C07F6;
	Mon,  4 Nov 2024 16:08:28 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="HJAL1hrf"
X-Original-To: linux-ext4@vger.kernel.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.9])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3544E1BE23E
	for <linux-ext4@vger.kernel.org>; Mon,  4 Nov 2024 16:08:25 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=198.175.65.9
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1730736507; cv=none; b=rZnQ1WKpzcGHOhEnxDVeLwVqCRNLOZYNDL7bFnHH5ueM9C2vH9tCiFdqArL9W0qu+BaWZEOVcDegT2bYE/FyXDJdsypjNgPy41kH2g0JhpHmyMKOnDpI2bQukqNXT4O5Lr+Ew4kfkFr3zPW7OZUlVR6hdL88vIdzK2dEvfPN95s=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1730736507; c=relaxed/simple;
	bh=MRFDqCEa5iR0+1lItVQrP4ba1524d1lLpqX3GXf/4VQ=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=ozJlWmdOA6sy/hBriZkRi5u9zqFwwCKkm+sXfX/suc1kHSTY4JcWEnFXvQZicbD5NwR+7j7ElcGU1LFjjaOFd7kIaF6PJLqHzM6vyVaJt++tXbOIrD8AWPlFj0gnYN+78mJ7vGa9Qll7mfGuPU1dLxT0xA0RiR50N8v8ZZI7Nb8=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=HJAL1hrf; arc=none smtp.client-ip=198.175.65.9
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1730736506; x=1762272506;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=MRFDqCEa5iR0+1lItVQrP4ba1524d1lLpqX3GXf/4VQ=;
  b=HJAL1hrfrADFAEk4ON7s4WFY0tnmEj1Lgwe/znkmAthVGVsfObeT2VGk
   ppMVBqFnq3RFKmcPpAmwTM4Ts75pqnUeTUKg2ivJPjzWFxayGpy9NetrZ
   T0id2Quh7T5pOG1yVo9vbMejVBVB7pKrd5igTWwbZADTMUCPKLjets95i
   mtjuVNE/4Fyfrb3eUf+RryjYQZLLycqEbW5GK0+j/RVdPLFsMZZyfSjYG
   ecMbImVrjgO1nzkQqdmAbHbRyhb+tOsWDbU5v3TUBUFMpsXi5n9LJXjq9
   uaEMjc4zlVoj08YpgWbnMd3psHfBmL85HphWRvQi8uWiMZ+uF3cLSqiCQ
   w==;
X-CSE-ConnectionGUID: FwcuHWjCSoCXz9JlxwhQ8g==
X-CSE-MsgGUID: BYjHYkUHS1i0qRrJoBRVYQ==
X-IronPort-AV: E=McAfee;i="6700,10204,11222"; a="53010581"
X-IronPort-AV: E=Sophos;i="6.11,199,1725346800"; 
   d="scan'208";a="53010581"
Received: from orviesa006.jf.intel.com ([10.64.159.146])
  by orvoesa101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 04 Nov 2024 08:08:25 -0800
X-CSE-ConnectionGUID: wRVOL/dGS76fIrZajIeRtw==
X-CSE-MsgGUID: y9VvXTIKQ4eGS72p3H1XGQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.11,257,1725346800"; 
   d="scan'208";a="83812116"
Received: from lkp-server01.sh.intel.com (HELO a48cf1aa22e8) ([10.239.97.150])
  by orviesa006.jf.intel.com with ESMTP; 04 Nov 2024 08:08:23 -0800
Received: from kbuild by a48cf1aa22e8 with local (Exim 4.96)
	(envelope-from <lkp@intel.com>)
	id 1t7zcq-000l0Q-2X;
	Mon, 04 Nov 2024 16:08:20 +0000
Date: Tue, 5 Nov 2024 00:07:25 +0800
From: kernel test robot <lkp@intel.com>
To: Li Dongyang <dongyangli@ddn.com>, linux-ext4@vger.kernel.org
Cc: oe-kbuild-all@lists.linux.dev, Andreas Dilger <adilger@dilger.ca>,
	Alex Zhuravlev <bzzz@whamcloud.com>
Subject: Re: [PATCH] jbd2: use rhashtable for revoke records during replay
Message-ID: <202411042321.ntLVyS1K-lkp@intel.com>
...
config: i386-buildonly-randconfig-002-20241104 (https://download.01.org/0day-ci/archive/20241104/202411042321.ntLVyS1K-lkp@intel.com/config)
compiler: gcc-12 (Debian 12.2.0-14) 12.2.0
reproduce (this is a W=1 build): (https://download.01.org/0day-ci/archive/20241104/202411042321.ntLVyS1K-lkp@intel.com/reproduce)

If you fix the issue in a separate patch/commit (i.e. not just a new version of
the same patch/commit), kindly add following tags
| Reported-by: kernel test robot <lkp@intel.com>
| Closes: https://lore.kernel.org/oe-kbuild-all/202411042321.ntLVyS1K-lkp@intel.com/

All errors (new ones prefixed by >>):

   In file included from fs/jbd2/checkpoint.c:19:
>> include/linux/jbd2.h:1128:33: error: field 'j_revoke_rhtable' has incomplete type
    1128 |         struct rhashtable       j_revoke_rhtable;
         |                                 ^~~~~~~~~~~~~~~~


vim +/j_revoke_rhtable +1128 include/linux/jbd2.h
