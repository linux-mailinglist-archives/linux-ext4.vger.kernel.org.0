Return-Path: <linux-ext4+bounces-783-lists+linux-ext4=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ext4@lfdr.de
Delivered-To: lists+linux-ext4@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 85B3582B774
	for <lists+linux-ext4@lfdr.de>; Thu, 11 Jan 2024 23:59:38 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 2EC2F2884C0
	for <lists+linux-ext4@lfdr.de>; Thu, 11 Jan 2024 22:59:37 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id F40CC5916C;
	Thu, 11 Jan 2024 22:59:09 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=suse.de header.i=@suse.de header.b="Hcv3sAvJ";
	dkim=permerror (0-bit key) header.d=suse.de header.i=@suse.de header.b="DTV75Uqv";
	dkim=pass (1024-bit key) header.d=suse.de header.i=@suse.de header.b="Hcv3sAvJ";
	dkim=permerror (0-bit key) header.d=suse.de header.i=@suse.de header.b="DTV75Uqv"
...
Received: from smtp-out2.suse.de (smtp-out2.suse.de [195.135.223.131])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 1EA0A3A1B7;
	Thu, 11 Jan 2024 22:59:07 +0000 (UTC)
