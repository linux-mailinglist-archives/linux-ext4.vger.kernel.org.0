...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id D6E7D270992
	for <lists+linux-ext4@lfdr.de>; Sat, 19 Sep 2020 02:55:22 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726244AbgISAzW (ORCPT <rfc822;lists+linux-ext4@lfdr.de>);
        Fri, 18 Sep 2020 20:55:22 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39568 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726192AbgISAzT (ORCPT
        <rfc822;linux-ext4@vger.kernel.org>); Fri, 18 Sep 2020 20:55:19 -0400
Received: from mail-pj1-x1044.google.com (mail-pj1-x1044.google.com [IPv6:2607:f8b0:4864:20::1044])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1C260C0613CF
        for <linux-ext4@vger.kernel.org>; Fri, 18 Sep 2020 17:55:19 -0700 (PDT)
Received: by mail-pj1-x1044.google.com with SMTP id mm21so4046978pjb.4
        for <linux-ext4@vger.kernel.org>; Fri, 18 Sep 2020 17:55:19 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=Gk9eYzpsyHzndYTg2ueqSvwxmAZyBV55SoaYkGe8UDo=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=Gk9eYzpsyHzndYTg2ueqSvwxmAZyBV55SoaYkGe8UDo=;
        b=
X-Gm-Message-State: AOAM531tvjpVPveBeW8I+0s+/sAJUk18blX2atZQeoUWdmo3Mbzljsy0
        v53iyXnKf4O1acgSa6hKmujBsbwbE/s=
X-Google-Smtp-Source: ABdhPJy2ADvLOSzMyD3gCp3ugiCZSSNQZ1hmrE718BfPwFofB3ZTIWxcVzAk2ouWgSVC4mXVdHiBRQ==
X-Received: by 2002:a17:902:eb05:b029:d1:8c50:b1bc with SMTP id l5-20020a170902eb05b02900d18c50b1bcmr34923466plb.35.1600476916825;
        Fri, 18 Sep 2020 17:55:16 -0700 (PDT)
Received: from harshads-520.kir.corp.google.com ([2620:15c:17:10:a6ae:11ff:fe11:86a2])
        by smtp.googlemail.com with ESMTPSA id f28sm4621953pfq.191.2020.09.18.17.55.15
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 18 Sep 2020 17:55:15 -0700 (PDT)
From:   Harshad Shirwadkar <harshadshirwadkar@gmail.com>
To:     linux-ext4@vger.kernel.org
Cc:     tytso@mit.edu, Harshad Shirwadkar <harshadshirwadkar@gmail.com>
Subject: [PATCH v9 7/9] ext4: fast commit recovery path
Date:   Fri, 18 Sep 2020 17:54:49 -0700
Message-Id: <20200919005451.3899779-8-harshadshirwadkar@gmail.com>
...
@@ -4283,6 +4365,9 @@ void ext4_discard_preallocations(struct inode *inode, unsigned int needed)
 		return;
 	}
...
@@ -4830,6 +4915,9 @@ static bool ext4_mb_discard_preallocations_should_retry(struct super_block *sb,
 	return ret;
 }
...
@@ -4851,6 +4939,8 @@ ext4_fsblk_t ext4_mb_new_blocks(handle_t *handle,
 	sbi = EXT4_SB(sb);
...
@@ -5078,6 +5168,102 @@ ext4_mb_free_metadata(handle_t *handle, struct ext4_buddy *e4b,
 	return 0;
 }
...
@@ -5104,6 +5290,13 @@ void ext4_free_blocks(handle_t *handle, struct inode *inode,
 	int err = 0;
 	int ret;
...
+
 	...
 	if (bh) {
 		if (block)
@@ -5112,7 +5305,6 @@ void ext4_free_blocks(handle_t *handle, struct inode *inode,
 			block = bh->b_blocknr;
 	}
...
index 563243f3b682..3c4d882d4d7b 100644
--- a/fs/ext4/namei.c
+++ b/fs/ext4/namei.c
...
@@ -3196,42 +3196,32 @@ static int ext4_rmdir(struct inode *dir, struct dentry *dentry)
 	return retval;
 }
...
@@ -3244,17 +3234,21 @@ static int ext4_unlink(struct inode *dir, struct dentry *dentry)
 	if (IS_DIRSYNC(dir))
...
+				   d_name->len, d_name->name);
 		...
 		drop_nlink(inode);
 	if (!inode->i_nlink)
@@ -3262,6 +3256,33 @@ static int ext4_unlink(struct inode *dir, struct dentry *dentry)
...
@@ -3275,10 +3296,6 @@ static int ext4_unlink(struct inode *dir, struct dentry *dentry)
 		d_invalidate(dentry);
 #endif
...
-	brelse(bh);
 out_trace:
 	...
 	return retval;
@@ -3359,7 +3376,8 @@ static int ext4_symlink(struct inode *dir,
 		 */
 		drop_nlink(inode);
...
+			ext4_journal_stop(handle);
 		...
 		if (err)
 			goto err_drop_inode;
@@ -3413,29 +3431,10 @@ static int ext4_symlink(struct inode *dir,
 	return err;
 }
...
@@ -3452,6 +3451,7 @@ static int ext4_link(struct dentry *old_dentry,
...
@@ -3469,6 +3469,29 @@ static int ext4_link(struct dentry *old_dentry,
 	return err;
 }
...
index 2a959e2c7a91..967c4eac87d2 100644
--- a/fs/ext4/super.c
+++ b/fs/ext4/super.c
@@ -1535,6 +1535,9 @@ enum {
...
@@ -1622,6 +1625,9 @@ static const match_table_t tokens = {
...
@@ -1850,6 +1856,9 @@ static const struct mount_opts {
 	 MOPT_SET},
...
@@ -2051,6 +2060,10 @@ static int handle_mount_opt(struct super_block *sb, char *opt, int token,
...
@@ -4560,6 +4573,13 @@ static int ext4_fill_super(struct super_block *sb, void *data, int silent)
...
@@ -4771,6 +4791,7 @@ static int ext4_fill_super(struct super_block *sb, void *data, int silent)
 			goto failed_mount4a;
 		}
 	}
...
index c8cb43189f02..50dc71366482 100644
