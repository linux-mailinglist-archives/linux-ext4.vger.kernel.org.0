...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 1DDB7228882
	for <lists+linux-ext4@lfdr.de>; Tue, 21 Jul 2020 20:45:32 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730247AbgGUSpa (ORCPT <rfc822;lists+linux-ext4@lfdr.de>);
        Tue, 21 Jul 2020 14:45:30 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37852 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1730188AbgGUSp2 (ORCPT
        <rfc822;linux-ext4@vger.kernel.org>); Tue, 21 Jul 2020 14:45:28 -0400
Received: from mail-pf1-x444.google.com (mail-pf1-x444.google.com [IPv6:2607:f8b0:4864:20::444])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 2F0C4C0619DA
        for <linux-ext4@vger.kernel.org>; Tue, 21 Jul 2020 11:45:28 -0700 (PDT)
Received: by mail-pf1-x444.google.com with SMTP id z3so11140709pfn.12
        for <linux-ext4@vger.kernel.org>; Tue, 21 Jul 2020 11:45:28 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=mIc+ZytbfYtImC5B6DRSCB2OQAZq7rhNHWufdGt8KcQ=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=mIc+ZytbfYtImC5B6DRSCB2OQAZq7rhNHWufdGt8KcQ=;
        b=
X-Gm-Message-State: AOAM530QLQ4i5L74IFT0wgQC+RaCGP72EL4okg9h8Sl6VNDQfBZ0l7rU
        1tRtPoadMkjyLxTRgUVShIyF+WgL
X-Google-Smtp-Source: ABdhPJzrZR8tPdVkdy/8EjL0rPJRmT5ZD8zzvL2t0Uo/qfHTJXi5/+RMLrio7G/ENZnyITDSLOBj+A==
X-Received: by 2002:a63:100b:: with SMTP id f11mr22728608pgl.287.1595357124851;
        Tue, 21 Jul 2020 11:45:24 -0700 (PDT)
Received: from harshads-520.kir.corp.google.com ([2620:15c:17:10:a6ae:11ff:fe11:86a2])
        by smtp.googlemail.com with ESMTPSA id b13sm4179890pjl.7.2020.07.21.11.45.23
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 21 Jul 2020 11:45:23 -0700 (PDT)
From:   Harshad Shirwadkar <harshadshirwadkar@gmail.com>
To:     linux-ext4@vger.kernel.org
Cc:     tytso@mit.edu, Harshad Shirwadkar <harshadshirwadkar@gmail.com>
Subject: [PATCH v8 7/7] ext4: fast commit recovery path
Date:   Tue, 21 Jul 2020 11:43:55 -0700
Message-Id: <20200721184355.1616986-8-harshadshirwadkar@gmail.com>
...
---
 ...
 15 files changed, 1740 insertions(+), 126 deletions(-)
...
index 62673f251e5c..342b7daa7c23 100644
...
+	    (EXT4_SB(inode->i_sb)->s_mount_state & EXT4_FC_REPLAY))
 ...
 restart:
@@ -325,7 +324,8 @@ static int ext4_fc_track_template(
 	struct ext4_sb_info *sbi = EXT4_SB(inode->i_sb);
 	int ret;
...
@@ -1188,13 +1188,846 @@ static void ext4_fc_cleanup(journal_t *journal, int full)
