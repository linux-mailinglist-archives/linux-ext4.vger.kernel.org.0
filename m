...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 3AEB02A8350
	for <lists+linux-ext4@lfdr.de>; Thu,  5 Nov 2020 17:18:11 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731060AbgKEQSK (ORCPT <rfc822;lists+linux-ext4@lfdr.de>);
        Thu, 5 Nov 2020 11:18:10 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33394 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1729361AbgKEQSA (ORCPT
        <rfc822;linux-ext4@vger.kernel.org>); Thu, 5 Nov 2020 11:18:00 -0500
Received: from bhuna.collabora.co.uk (bhuna.collabora.co.uk [IPv6:2a00:1098:0:82:1000:25:2eeb:e3e3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6B878C0613D2
...
Received: from xps.home (unknown [IPv6:2a01:e35:2fb5:1510:4a7e:bc14:686e:75db])
        ...
        by bhuna.collabora.co.uk (Postfix) with ESMTPSA id A2DC31F46122;
        Thu,  5 Nov 2020 16:17:58 +0000 (GMT)
From:   Arnaud Ferraris <arnaud.ferraris@collabora.com>
To:     linux-ext4@vger.kernel.org
Cc:     Gabriel Krisman Bertazi <krisman@collabora.com>,
        Arnaud Ferraris <arnaud.ferraris@collabora.com>
Subject: [PATCH 05/11] e2fsck: Fix entries with invalid encoded characters
Date:   Thu,  5 Nov 2020 17:16:37 +0100
Message-Id: <20201105161642.87488-6-arnaud.ferraris@collabora.com>
...
--- a/e2fsck/pass1.c
+++ b/e2fsck/pass1.c
@@ -1260,6 +1260,20 @@ void e2fsck_pass1(e2fsck_t ctx)
...
+	}
 	pctx.errcode = e2fsck_setup_icount(ctx, "inode_link_info", 0, NULL,
 					   &ctx->inode_link_info);
 	if (pctx.errcode) {
@@ -1870,6 +1884,9 @@ void e2fsck_pass1(e2fsck_t ctx)
...
index 4dbc44ea..4073edbc 100644
--- a/e2fsck/pass2.c
+++ b/e2fsck/pass2.c
@@ -36,11 +36,13 @@
