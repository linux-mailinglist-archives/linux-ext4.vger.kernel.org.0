...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 338365388D7
	for <lists+linux-ext4@lfdr.de>; Tue, 31 May 2022 00:21:09 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234479AbiE3WVF (ORCPT <rfc822;lists+linux-ext4@lfdr.de>);
        Mon, 30 May 2022 18:21:05 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58156 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232789AbiE3WVE (ORCPT
        <rfc822;linux-ext4@vger.kernel.org>); Mon, 30 May 2022 18:21:04 -0400
Received: from mail-oi1-x22e.google.com (mail-oi1-x22e.google.com [IPv6:2607:f8b0:4864:20::22e])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 43A407B9E0
        for <linux-ext4@vger.kernel.org>; Mon, 30 May 2022 15:21:01 -0700 (PDT)
Received: by mail-oi1-x22e.google.com with SMTP id r206so8253543oib.8
        for <linux-ext4@vger.kernel.org>; Mon, 30 May 2022 15:21:01 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :cc;
        bh=uMcKl2SpV3yWdS9qPoKAHSTkhT38wVQfYMlfwoVclOw=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=uMcKl2SpV3yWdS9qPoKAHSTkhT38wVQfYMlfwoVclOw=;
        b=
X-Gm-Message-State: AOAM5324SNUGEnD4UYCXnIzNbZ/Qc96pb1HvIkh9eUb0coZ5gPLMwlyb
        VkJIkFRm7d2Nh9AvqSO33QW2ZhYlSKBfvvEVKrVXMownKsHmsg==
X-Google-Smtp-Source: ABdhPJysMBGEtAcYkfhW1wek4ThsXm4ppeB2So+xdRNPu+yIBrP7FokN+gw1Z/GtqY1k0YfbnGQ+llN5n93OeFzs0oU=
X-Received: by 2002:a05:6808:144d:b0:32b:7fbc:9440 with SMTP id
 x13-20020a056808144d00b0032b7fbc9440mr10639076oiv.226.1653949259776; Mon, 30
 May 2022 15:20:59 -0700 (PDT)
MIME-Version: 1.0
...
In-Reply-To: <YpQixl+ljcC1VHNU@mit.edu>
From:   "Stephen E. Baker" <baker.stephen.e@gmail.com>
Date:   Mon, 30 May 2022 18:20:46 -0400
Message-ID: <CAFDdnB1WxrqddeLJwjsqqgoij1q_QGa=SBs-i=j31W2QbksJ=Q@mail.gmail.com>
...
On Sun, May 29, 2022 at 9:50 PM Theodore Ts'o <tytso@mit.edu> wrote:
>
...
>
Unfortunately I already had CONFIG_UNICODE_UTF8_DATA=y

I also verified the make target was generated:
food% find -name 'utf8data.o'
./fs/unicode/utf8data.o

food% nm ./fs/unicode/utf8data.o
0000000000000000 r $d
0000000000000000 d $d
0000000000000000 r $d
0000000000000018 r __UNIQUE_ID_file287
0000000000000000 r __UNIQUE_ID_license288
0000000000000000 d __ksym_marker_utf8_data_table
0000000000000000 D utf8_data_table
000000000000fc70 r utf8agetab
0000000000000000 r utf8data
000000000000fbb8 r utf8nfdicfdata
000000000000fb00 r utf8nfdidata

Further the symbols appear to be in the kernel:
food% nm vmlinux | grep 'utf8_data'
ffff8000112b8488 D utf8_data_table

This device doesn't directly use vmlinux, but a signed image.
My distro is ArchLinux ARM, and my kernel packages are based on theirs:
https://github.com/archlinuxarm/PKGBUILDs/blob/30c181baea493effe3bea7b3a2c3ec6ee62b41ae/core/linux-aarch64/PKGBUILD#L201-L228
...
# Linux/arm64 5.15.0-rc4 Kernel Configuration
#
CONFIG_CC_VERSION_TEXT="aarch64-linux-gnu-gcc (GCC) 11.2.0"
CONFIG_CC_IS_GCC=y
