...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7B51A447CA8
	for <lists+linux-ext4@lfdr.de>; Mon,  8 Nov 2021 10:18:40 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S238317AbhKHJVX (ORCPT <rfc822;lists+linux-ext4@lfdr.de>);
        Mon, 8 Nov 2021 04:21:23 -0500
Received: from us-smtp-delivery-124.mimecast.com ([170.10.133.124]:45096 "EHLO
        us-smtp-delivery-124.mimecast.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S236719AbhKHJVW (ORCPT
        <rfc822;linux-ext4@vger.kernel.org>); Mon, 8 Nov 2021 04:21:22 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1636363118;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         in-reply-to:in-reply-to:references:references;
        bh=lyrsU//mULqi2xD3DPUXfyAsJoKJ7tCGHQsDE/fGMJQ=;
        b=frLfFL3lAaSpw19OyUoAKcH3xrSP78erJb+bMKS9v7Jk2FTkDu5SGX2GWDT1DO6gc3MMy1
        eJD9ajTvR3tIL2ruijWf48+P/Uz7E7a138cFrD4stGT5OwosZQPpqBufSEl33xKCH/09oZ
        ywE61wWUErY9uM032W0MdW0qeZM7TQE=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-338-ITewy6jVOq6ij2zc7lM-PA-1; Mon, 08 Nov 2021 04:18:34 -0500
X-MC-Unique: ITewy6jVOq6ij2zc7lM-PA-1
Received: from smtp.corp.redhat.com (int-mx05.intmail.prod.int.phx2.redhat.com [10.5.11.15])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 224EC18D6A25;
        Mon,  8 Nov 2021 09:18:33 +0000 (UTC)
Received: from work (unknown [10.40.194.220])
        by smtp.corp.redhat.com (Postfix) with ESMTPS id 1DA6D5D705;
        Mon,  8 Nov 2021 09:18:30 +0000 (UTC)
Date:   Mon, 8 Nov 2021 10:18:31 +0100
...
Message-ID: <20211108091831.tguxwthbqlqwjlt7@work>
...
Thanks for the tip. However it is missing the location that works most
reliably on the systems I tried recently and that is
/lib/modules/$(uname -r)/build/.config

Most of my systems don't have anything else for the custom kernels I am
testing.

Anyway I am going to model it after that and move the helpers to
common/rc.
