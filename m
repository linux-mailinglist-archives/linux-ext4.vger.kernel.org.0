Return-Path: <linux-ext4+bounces-2884-lists+linux-ext4=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-ext4@lfdr.de
Delivered-To: lists+linux-ext4@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 676E19093BD
	for <lists+linux-ext4@lfdr.de>; Fri, 14 Jun 2024 23:44:01 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 458E71F22DF8
	for <lists+linux-ext4@lfdr.de>; Fri, 14 Jun 2024 21:44:00 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C8258185087;
	Fri, 14 Jun 2024 21:43:49 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="PYg7fvUH"
X-Original-To: linux-ext4@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 31E25143C7A;
	Fri, 14 Jun 2024 21:43:48 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1718401429; cv=none; b=FeQNMlDpUNutJrWSmOf8fC1T34UotHodblhbFGEtWP7cfI4S9MtSOEuEAQJ5RH+eMjAfilAL7SGUVMw6snECGjjG1rp9mOvGwb+FFejoBLIXjlvRJdWzWgE7jY2VfZsoa6n8epDRlXAB0lLThNBoPJC80zOuZXUr88uJj5vj/MA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1718401429; c=relaxed/simple;
	bh=hpVgdc4ziK0bS43nVP7LzAwfxXe1bmLoww+MEFS8bBE=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type:
	 Content-Disposition; b=HpcmgUKT94fgavPAq9xi/7DjjI5IgO9gMfCmCMduwOVVYZ6Pc2FI4OnMkJDvVIXxuMY2WnSUhFfEq59VCBiBLlBacdGq0wFx260eXP6zsbnxs3UZ7H2/cNmd1PvaeyaBDY95QCGr59Ylw6culU4ybFgn4YV+tKIneJnErx7C8p0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=PYg7fvUH; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 88622C4AF1A;
	Fri, 14 Jun 2024 21:43:48 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1718401428;
	bh=hpVgdc4ziK0bS43nVP7LzAwfxXe1bmLoww+MEFS8bBE=;
	h=Date:From:To:Cc:Subject:From;
	b=
Date: Fri, 14 Jun 2024 14:43:47 -0700
...
Subject: [PATCH v2] Documentation: the design of iomap and how to port
Message-ID: <20240614214347.GK6125@frogsfrogsfrogs>
Precedence: bulk
...
---
v2: incorporate a ton of feedback, split up documents, fix glaring
inaccuracies.

I will send the text-only renderings of these documents as replies to
this patchmail.
---
...
index 8754ac2c259d..b9fd24c46075 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
