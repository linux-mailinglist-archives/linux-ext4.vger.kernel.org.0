...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id BF68C31B0A0
	for <lists+linux-ext4@lfdr.de>; Sun, 14 Feb 2021 14:55:49 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229740AbhBNNym (ORCPT <rfc822;lists+linux-ext4@lfdr.de>);
        Sun, 14 Feb 2021 08:54:42 -0500
Received: from mga03.intel.com ([134.134.136.65]:20045 "EHLO mga03.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S229637AbhBNNyg (ORCPT <rfc822;linux-ext4@vger.kernel.org>);
        Sun, 14 Feb 2021 08:54:36 -0500
IronPort-SDR: y5lYL2mvnWLDjCDnObXG91cxKLUzFwitOavUlJWJ+w2Q7vToaUi6WyGj0EYoksQnNoUfsgWPgv
 afKz5YebXBJw==
X-IronPort-AV: E=McAfee;i="6000,8403,9894"; a="182649573"
X-IronPort-AV: E=Sophos;i="5.81,178,1610438400"; 
   d="yaml'?scan'208";a="182649573"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 14 Feb 2021 05:53:46 -0800
IronPort-SDR: EcXutsYUngLUSC0KaQn7FSJ6Va8QRQEEukE+Yt95Ik9CCJ3HpAdnfPtRQYSs7nfu/VHjHAqf61
 CctabpqcONjQ==
X-IronPort-AV: E=Sophos;i="5.81,178,1610438400"; 
   d="yaml'?scan'208";a="398683581"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.140])
  by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 14 Feb 2021 05:53:41 -0800
Date:   Sun, 14 Feb 2021 22:09:21 +0800
From:   kernel test robot <oliver.sang@intel.com>
To:     Harshad Shirwadkar <harshadshirwadkar@gmail.com>
Cc:     0day robot <lkp@intel.com>, LKML <linux-kernel@vger.kernel.org>,
        lkp@lists.01.org, ying.huang@intel.com, feng.tang@intel.com,
        zhengjun.xing@intel.com, linux-ext4@vger.kernel.org, tytso@mit.edu,
...
Subject: [ext4]  ef4eebad9c:
 fxmark.hdd_ext4_no_jnl_MWCL_1_bufferedio.works/sec -9.8% regression
Message-ID: <20210214140921.GD6321@xsang-OptiPlex-9020>
MIME-Version: 1.0
...
Content-Disposition: attachment; filename="config-5.11.0-rc6-00009-gef4eebad9c01"
...
export_top_env()
{
	...
	export media='hdd'
	export job_origin='fxmark-lkp-knm01.yaml'
...
queue_at_least_once'
	...
	export submit_id='6027053f8e58016c986d4b25'
	export job_file='/lkp/jobs/scheduled/lkp-knm01/fxmark-performance-bufferedio-1HDD-ext4_no_jnl-hdd-MWCL-ucode=0x11-monitor=70d6d718-debian-10.4-x86_64-20200603.cgz-ef4eebad9c01-20210213-27800-1t7u2u3-3.yaml'
	export id='4cb6186128e66c6a9a0ec7aa02e2bbb5d172f315'
...
CONFIG_PCI=y
CONFIG_F2FS_FS=m'
	export commit='ef4eebad9c018a972a470b7b41e68bc981b31d00'
	export need_kconfig_hw='CONFIG_IGB=y
CONFIG_SATA_AHCI
CONFIG_BLK_DEV_NVME'
	export ucode='0x11'
	export enqueue_time='2021-02-13 06:46:23 +0800'
	export _id='602705418e58016c986d4b26'
	export _rt='/result/fxmark/performance-bufferedio-1HDD-ext4_no_jnl-hdd-MWCL-ucode=0x11-monitor=70d6d718/lkp-knm01/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/ef4eebad9c018a972a470b7b41e68bc981b31d00'
	export user='lkp'
	export compiler='gcc-9'
	export LKP_SERVER='internal-lkp-server'
	export head_commit='8f961232626bc3d4f0bcca0c5abc0b73946141e7'
	export base_commit='92bf22614b21a2706f4993b278017e437f7785b3'
	export branch='linux-review/Harshad-Shirwadkar/ext4-drop-s_mb_bal_lock-and-convert-protected-fields-to-atomic/20210210-054647'
	export rootfs='debian-10.4-x86_64-20200603.cgz'
	export monitor_sha='70d6d718'
	export result_root='/result/fxmark/performance-bufferedio-1HDD-ext4_no_jnl-hdd-MWCL-ucode=0x11-monitor=70d6d718/lkp-knm01/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/ef4eebad9c018a972a470b7b41e68bc981b31d00/3'
...
user=lkp
job=/lkp/jobs/scheduled/lkp-knm01/fxmark-performance-bufferedio-1HDD-ext4_no_jnl-hdd-MWCL-ucode=0x11-monitor=70d6d718-debian-10.4-x86_64-20200603.cgz-ef4eebad9c01-20210213-27800-1t7u2u3-3.yaml
ARCH=x86_64
kconfig=x86_64-rhel-8.3
branch=linux-review/Harshad-Shirwadkar/ext4-drop-s_mb_bal_lock-and-convert-protected-fields-to-atomic/20210210-054647
commit=ef4eebad9c018a972a470b7b41e68bc981b31d00
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/ef4eebad9c018a972a470b7b41e68bc981b31d00/vmlinuz-5.11.0-rc6-00009-gef4eebad9c01
max_uptime=2100
RESULT_ROOT=/result/fxmark/performance-bufferedio-1HDD-ext4_no_jnl-hdd-MWCL-ucode=0x11-monitor=70d6d718/lkp-knm01/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/ef4eebad9c018a972a470b7b41e68bc981b31d00/3
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-9/ef4eebad9c018a972a470b7b41e68bc981b31d00/modules.cgz'
	...
	export last_kernel='5.11.0-rc7-09617-g8f961232626b'
	export repeat_to=4
	export queue_at_least_once=1
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-9/ef4eebad9c018a972a470b7b41e68bc981b31d00/vmlinuz-5.11.0-rc6-00009-gef4eebad9c01'
	export dequeue_time='2021-02-13 07:25:55 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-knm01/fxmark-performance-bufferedio-1HDD-ext4_no_jnl-hdd-MWCL-ucode=0x11-monitor=70d6d718-debian-10.4-x86_64-20200603.cgz-ef4eebad9c01-20210213-27800-1t7u2u3-3.cgz'
...
run_job()
{
	...
	run_test test='MWCL' fstype='ext4_no_jnl' directio='bufferedio' $LKP_SRC/tests/wrapper fxmark
}
...
extract_stats()
{
	...
	env test='MWCL' fstype='ext4_no_jnl' directio='bufferedio' $LKP_SRC/stats/wrapper fxmark
...
fxmark:
  ...
  fstype: ext4_no_jnl
  directio: bufferedio
job_origin: fxmark-lkp-knm01.yaml
...
kconfig: x86_64-rhel-8.3
submit_id: 6026e2f48e580168d4736d47
job_file: "/lkp/jobs/scheduled/lkp-knm01/fxmark-performance-bufferedio-1HDD-ext4_no_jnl-hdd-MWCL-ucode=0x11-monitor=70d6d718-debian-10.4-x86_64-20200603.cgz-ef4eebad9c01-20210213-26836-1q2f9do-0.yaml"
id: 0eace580589b8f5075a619726a3de733f57c776c
...
- CONFIG_BLK_DEV_NVME
ucode: '0x11'
enqueue_time: 2021-02-13 04:20:04.878586655 +08:00
_id: 6026e2f48e580168d4736d47
_rt: "/result/fxmark/performance-bufferedio-1HDD-ext4_no_jnl-hdd-MWCL-ucode=0x11-monitor=70d6d718/lkp-knm01/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/ef4eebad9c018a972a470b7b41e68bc981b31d00"

#! schedule options
user: lkp
compiler: gcc-9
LKP_SERVER: internal-lkp-server
head_commit: 8f961232626bc3d4f0bcca0c5abc0b73946141e7
base_commit: 92bf22614b21a2706f4993b278017e437f7785b3
branch: linux-devel/devel-hourly-20210211-145722
rootfs: debian-10.4-x86_64-20200603.cgz
monitor_sha: 70d6d718
result_root: "/result/fxmark/performance-bufferedio-1HDD-ext4_no_jnl-hdd-MWCL-ucode=0x11-monitor=70d6d718/lkp-knm01/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/ef4eebad9c018a972a470b7b41e68bc981b31d00/0"
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-knm01/fxmark-performance-bufferedio-1HDD-ext4_no_jnl-hdd-MWCL-ucode=0x11-monitor=70d6d718-debian-10.4-x86_64-20200603.cgz-ef4eebad9c01-20210213-26836-1q2f9do-0.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- branch=linux-devel/devel-hourly-20210211-145722
- commit=ef4eebad9c018a972a470b7b41e68bc981b31d00
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-9/ef4eebad9c018a972a470b7b41e68bc981b31d00/modules.cgz"
...
#! runtime status
last_kernel: 5.11.0-rc7-08600-g41f574cf1499
repeat_to: 2

#! user overrides
queue_at_least_once: 0
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-9/ef4eebad9c018a972a470b7b41e68bc981b31d00/vmlinuz-5.11.0-rc6-00009-gef4eebad9c01"
dequeue_time: 2021-02-13 05:39:59.506117939 +08:00
job_state: finished
loadavg: 1.85 5.43 6.49 1/2132 33471
start_time: '1613166133'
end_time: '1613167259'
